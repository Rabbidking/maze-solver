...
class Maze:
    ...
    def _draw_cell(self, i, j):
        #calculates x and y positions of the cell using i and j, the cell size, and the x and y positons of the whole maze
        if self.win is None:
            return
    ...
    def _break_entrance_and_exit(self):
        #maze entrance is always at the top of the top-left cell, exit is always at the bottom of the bottom-right cell
        #Removes outer wall from these specific cells, then redraws them
